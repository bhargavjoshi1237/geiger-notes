  ...
  return (
    <DropdownMenu modal={false}>
      ...
      <DropdownMenuContent
        align="end"
        sideOffset={8}
        className="z-[100] w-80 max-w-[calc(100vw-2rem)] bg-[#1a1a1a] border-[#242424] text-zinc-100 shadow-xl p-0"
      ...
      >
        ...
        <DropdownMenuSeparator className="bg-[#242424] m-0" />
          ...
          {notifications.length === 0 ? (
            ...
            <div className="divide-y divide-zinc-800/50">
              {notifications.map((notification) => (
                <div
                  key={notification.id}
                  className="p-3 flex gap-3 hover:bg-zinc-800/30 transition-colors"
                >
