      ...
      >
        ...
        <div className="flex-1 w-full h-full overflow-hidden flex items-center px-4 gap-3">
          ...
          <div className="flex flex-col min-w-0">
            ...
            <span className="text-muted-foreground text-[10px] uppercase tracking-wider font-semibold truncate">
        ...
        <Handle
          ...
          `}
        >
          <ArrowRight className="w-[10px] h-[10px] opacity-0 group-hover/handle-tl:opacity-100 transition-opacity duration-200 text-background -rotate-[135deg]" />
        </Handle>
        ...
        <Handle
          ...
          `}
        >
          <ArrowRight className="w-[10px] h-[10px] opacity-0 group-hover/handle-bl:opacity-100 transition-opacity duration-200 text-background rotate-[135deg]" />
        </Handle>
      </div>
    </>
  );
